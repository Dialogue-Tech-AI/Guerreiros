...
export const DIVISION_UI_DEFINITIONS: DivisionUiDefinition[] = [
  ...
  { group: 'Follow-up', key: 'follow-up', defaultLabel: 'Follow up' },
  { group: 'Follow-up', key: 'inativo-1h', defaultLabel: 'Aguardando 1º Follow up' },
  { group: 'Follow-up', key: 'inativo-12h', defaultLabel: 'Aguardando 2º Follow up' },
  { group: 'Follow-up', key: 'inativo-24h', defaultLabel: 'Aguardando' },
